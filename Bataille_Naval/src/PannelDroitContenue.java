...
public class PannelDroitContenue extends JPanel{
	/**
	 * 
	 */
...
////////////////////Boutton////////////////////////////
	//Colonne a
	private Case a_1; // Faire de meme pour tout les autres JButton en remplacant le type JButton par case
	private JButton a_2;
	private JButton a_3;
	private JButton a_4;
	private JButton a_5;
...
//////////////////////////// Constructeur //////////////////////////////
	...
	public PannelDroitContenue() {
		...
		this.a_1 = new Case(1, 1); //remplacer les constructeur par case(int numeroColonne(x) ,int numero Ligne (y))
